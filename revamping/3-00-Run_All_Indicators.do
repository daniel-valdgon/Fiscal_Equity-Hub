...
*===============================================================================
include "${revamp_scripts}/3-00-Setup.do"
...
forvalues i = 1/$n_datasets {
	...
	*--- Run each indicator module -----------------------------------------
	include "${revamp_scripts}/3-02-Netcash_Incidence.do"
	include "${revamp_scripts}/3-03-Gini_Theil.do"
	include "${revamp_scripts}/3-04-Poverty_FGT.do"
	include "${revamp_scripts}/3-05-Marginal_Contributions.do"
	include "${revamp_scripts}/3-06-Coverage.do"
	include "${revamp_scripts}/3-07-Mean_Income.do"
	include "${revamp_scripts}/3-08-Concentration_Kakwani.do"
	include "${revamp_scripts}/3-11-Redistributive_Impact.do"
	include "${revamp_scripts}/3-12-Conditional_Incidence.do"
	include "${revamp_scripts}/3-13-Concentration_Shares_CC_Kakwani.do"
	include "${revamp_scripts}/3-14-Targeting_Errors.do"
	include "${revamp_scripts}/3-15-CEQ_Effectiveness.do"
	include "${revamp_scripts}/3-16-Consumption_Shares.do"

	*--- Merge taxonomy & export -------------------------------------------
	include "${revamp_scripts}/3-09-Taxonomy_Export.do"
}

*===============================================================================
*---> Step 3: Cross-country assembly
*===============================================================================
include "${revamp_scripts}/3-10-Cross_Country.do"
