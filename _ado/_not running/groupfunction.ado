...
cap mata: drop mata _CPBgini()
cap mata: drop mata _CPBginis() 
cap mata: drop mata _CPBfgt()
cap mata: drop mata _CPBfgts()
cap mata: drop mata _fpctilebig()
cap mata: drop mata _CPBtheil()
cap mata: drop mata _CPBtheils()
